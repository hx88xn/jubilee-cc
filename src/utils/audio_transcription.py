...
async def analyze_call_with_llm(call_id: str, user_transcript: str, agent_transcript: str) -> dict:
    ...
    analysis_prompt = f"""Analyze this Jubilee Life Insurance contact-center call and provide structured analysis.
...
{{
    ...
    "inquiry_type": "New Policy / Premium Payment / Claims / Policy Service / Takaful / Bancassurance / Panel Hospital / Customer Portal / Complaint / General Information / Other",
    ...
    "health_or_emergency_mentioned": true/false,
    "agent_performance": {{
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "You are a call quality analyst for Jubilee Life Insurance (Pakistan). "
                        "Analyze calls professionally and return structured JSON."
                    ),
                },
