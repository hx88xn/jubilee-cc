...
app = FastAPI(
    title="Jubilee Life Voice Agent",
    description="AI-powered voice call center demo for Jubilee Life Insurance",
    version="1.0.0",
)

JWT_SECRET_KEY = os.getenv("JWT_SECRET_KEY", "jubilee-life-voice-agent-secret-2026")
JWT_ALGORITHM = "HS256"
